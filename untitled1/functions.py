       ...
       #for boat in player.boats:
        ...
        #for boat in player2.boats:
                ...
                #for boat in player.boats:
                    #boat.turn== boat.moves
    def move(self):
        if self.turn > 0 and self.playing == True:
...
def collide(x,x2,player):
    ...
    if x.image.get_rect(x=x.p_x, y=x.p_y, ).colliderect(x2.image.get_rect(x=x2.p_x, y=x2.p_y, ))  and x.attack== True and click[0]==1 and x2.image.get_rect(x=x2.p_x, y= x2.p_y).collidepoint(pygame.mouse.get_pos()):
       x2.health -= 1
       x.attack= False
    if x2.health == 0:
        player.remove(x2)
...
def intro_game():
    ...
    while not gameExit:
        ...
        for boat in player2.boats:
            screen.blit(boat.image,(boat.p_x,boat.p_y),  boat.show_state())
        if len(player1.boats) == 4 and len(player2.boats) == 4:
            if player1.boats[0].turn > 0 or player1.boats[1].turn > 0 or player1.boats[2].turn > 0 or player1.boats[3].turn > 0 :
                ...
                if player1.boats[0].turn == 0 and player1.boats[1].turn == 0 and player1.boats[2].turn == 0 and player1.boats[3].turn == 0:
            ...
            elif  player2.boats[0].turn > 0 or player2.boats[1].turn > 0 or player2.boats[2].turn > 0 or player2.boats[3].turn > 0:
                ...
                if player2.boats[0].turn == 0 and player2.boats[1].turn == 0 and player2.boats[2].turn == 0 and player2.boats[3].turn == 0:
